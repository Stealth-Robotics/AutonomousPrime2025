...
public class FarFullCycleAuto extends StealthOpMode {
    ...
    public Command getAutoCommand(){
        return new SequentialCommandGroup(
                ...
                new AutonomousShootCommand(robot),
                builder.cycle(AutoBuilder.preset.MIDDLE,false,false),
                new AutonomousShootCommand(robot),
                builder.cycle(AutoBuilder.preset.NEAR,false,false),
                new AutonomousShootCommand(robot),
                builder.parkFar(),
    ...
    public static class RedFarFullCycleAuto extends FarFullCycleAuto {
    }

    @SuppressWarnings("unused")
    @Autonomous(name = "BlueFarFullCycle", group = "Blue")
    public static class BlueFarFullCycleAuto extends FarFullCycleAuto {
    }
}
