...
public class NearSingleCycleAuto extends StealthOpMode {
    ...
    public static class RedNearSingleCycleAuto extends NearSingleCycleAuto {
    }

    @SuppressWarnings("unused")
    @Autonomous(name = "BlueNearSingleCycle", group = "Blue")
    public static class BlueNearSingleCycleAuto extends NearSingleCycleAuto {
    }
}
